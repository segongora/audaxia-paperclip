          ...
          <div className="space-y-2 rounded-md border border-border/70 p-3">
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="min-w-0 space-y-1">
                  ...
                  {codebase.origin === "managed_checkout" && (
                    <div className="text-[11px] text-muted-foreground">Datamatic Software-managed folder.</div>
                  )}
                </div>
                <div className="flex items-center gap-1">
                  <Button
            ...
            {hasAdditionalLegacyWorkspaces && (
              <div className="text-[11px] text-muted-foreground">
                Additional legacy workspace records exist on this project. Datamatic Software is using the primary workspace as the codebase view.
              </div>
            )}
